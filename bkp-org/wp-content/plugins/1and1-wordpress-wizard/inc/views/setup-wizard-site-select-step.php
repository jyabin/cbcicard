	...
	static public function get_site_selection() {
		...
		<form action="<?php echo esc_url( add_query_arg( array( 'setup_action' => 'choose_appearance' ) ) ); ?>" method="post">
			...
			<div class="wrap">
				...
				<h3 class="clear"><?php esc_html_e( 'Select your website type', '1and1-wordpress-wizard' ); ?></h3>

				<p><?php esc_html_e( 'Each website type offers a selection of plugins and themes that we have optimised for your website.', '1and1-wordpress-wizard' ); ?></p>
				<br/>
						...
						foreach ( $site_types as $site_type ) {
							...
							<div class="oneandone-site-selection">
								...
								<div class="oneandone-site-type-actions">
									...
									<input type="hidden" name="sitetypename[<?php echo $site_type->get_id(); ?>]" value="<?php echo $site_type->get_name(); ?>" />
								</div>
							</div>
						<?php
						}
