	...
	static public function get_theme_selection( $site_type ) {
		...
		<form action="<?php echo esc_url( add_query_arg( array( 'setup_action' => 'choose_functionality' ) ) ); ?>" method="post">
			...
			<div class="wrap">
				...
				<h3 class="clear"><?php esc_html_e( 'Select your design', '1and1-wordpress-wizard' ) ?></h3>

				<p><?php esc_html_e( 'Use themes to control what your website looks like. You can easily adjust and personalise all themes later. We recommend these themes:', '1and1-wordpress-wizard' ) ?></p>
				<br/>
