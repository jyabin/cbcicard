...
if($writer!="")
{
$args = array( 'posts_per_page' =>25, 'order'=> 'Desc','author_name'=>''.$writer.'','orderby' => 'ID','post_type' => 'success-stories');
}else{
$args = array( 'posts_per_page' =>25, 'order'=> 'Desc', 'orderby' => 'ID','post_type' => 'success-stories');
}
